...
Test Case fru
    ...
    ${result}    Run    ${EXECDIR}/tool/ipmitool-1.8.18-cygwin-binary/ipmitool.exe ${bmc_login} fru
    Log to console    ${\n}    
...
Test Case2 mc info
    ...
    ${result}    Run    ${EXECDIR}/tool/ipmitool-1.8.18-cygwin-binary/ipmitool.exe ${bmc_login} mc info
    Log to console    ${\n}
    Log to console    ${result}
    Create File    ${EXECDIR}/${file_name}.txt    ${result}
    ${frt}    Run    type ${file_name}.txt | find "Product Name"
