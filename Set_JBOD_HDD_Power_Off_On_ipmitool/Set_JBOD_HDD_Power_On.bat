@echo off
:: for Set JBOD HDD Power On form ipmitool
...
:done
echo."04" was found !_count! times.
...
if "%slot_num%"=="0" (echo "No Power OFF slot, Do notting")
...
:: raw 0x3c 0x32 slot_num  action(0:off, 1:on)
:: ipmitool.exe -I lanplus -H %BMC_IP% -U admin -P %BMC_Password% raw 0x3C 0x32 1 1
...
for /L %%i in (1 1 %slot_num%) do (
    ...
    echo wait 8 sec... make device ready...
